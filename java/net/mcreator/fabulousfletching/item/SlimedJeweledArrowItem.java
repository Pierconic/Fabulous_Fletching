...
public class SlimedJeweledArrowItem extends ArrowItem {
	public SlimedJeweledArrowItem() {
		super(new Item.Properties().stacksTo(64));
	}
	
	@Override
	public AbstractArrow createArrow(Level world, ItemStack stack, LivingEntity shooter, @Nullable ItemStack weapon){
		return new SlimedJeweledArrowProjectileEntity(FabulousfletchingModEntities.SLIMED_JEWELED_ARROW_PROJECTILE.get(), shooter, world, stack.copyWithCount(1));
	}

	@Override 
	public Projectile asProjectile(Level world, Position pos, ItemStack stack, Direction direction) {
		SlimedJeweledArrowProjectileEntity jeweledarrow = new SlimedJeweledArrowProjectileEntity(FabulousfletchingModEntities.SLIMED_JEWELED_ARROW_PROJECTILE.get(), pos.x(), pos.y(), pos.z(), world, stack.copyWithCount(1));
