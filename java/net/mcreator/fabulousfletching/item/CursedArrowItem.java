...
public class CursedArrowItem extends ArrowItem {
	public CursedArrowItem() {
		super(new Item.Properties().stacksTo(64));
	}
	
	@Override
	public AbstractArrow createArrow(Level world, ItemStack stack, LivingEntity shooter, @Nullable ItemStack weapon){
		return new CursedArrowProjectileEntity(FabulousfletchingModEntities.CURSED_ARROW_PROJECTILE.get(), shooter, world, stack.copyWithCount(1));
	}

	@Override 
	public Projectile asProjectile(Level world, Position pos, ItemStack stack, Direction direction) {
		CursedArrowProjectileEntity cursedarrow = new CursedArrowProjectileEntity(FabulousfletchingModEntities.CURSED_ARROW_PROJECTILE.get(), pos.x(), pos.y(), pos.z(), world, stack.copyWithCount(1));
		cursedarrow.pickup = AbstractArrow.Pickup.ALLOWED;
		return cursedarrow;
	}
}
	//@Override
