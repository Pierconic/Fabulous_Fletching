...
public class VolatileForgedArrowItem extends ArrowItem {
	public VolatileForgedArrowItem() {
	...
	public AbstractArrow createArrow(Level world, ItemStack stack, LivingEntity shooter, @Nullable ItemStack weapon){
		return new VolatileForgedArrowProjectileEntity(FabulousfletchingModEntities.VOLATILE_FORGED_ARROW_PROJECTILE.get(), shooter, world, stack.copyWithCount(1));
	}

	@Override 
	public Projectile asProjectile(Level world, Position pos, ItemStack stack, Direction direction) {
		VolatileForgedArrowProjectileEntity forgedarrow = new VolatileForgedArrowProjectileEntity(FabulousfletchingModEntities.VOLATILE_FORGED_ARROW_PROJECTILE.get(), pos.x(), pos.y(), pos.z(), world, stack.copyWithCount(1));
