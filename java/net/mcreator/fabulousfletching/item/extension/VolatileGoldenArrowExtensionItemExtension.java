...
public class VolatileGoldenArrowExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(FabulousfletchingModItems.VOLATILE_GOLDEN_ARROW.get(), new OptionalDispenseItemBehavior() {
