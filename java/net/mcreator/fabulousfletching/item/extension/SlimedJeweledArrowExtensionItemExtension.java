...
public class SlimedJeweledArrowExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(FabulousfletchingModItems.SLIMED_JEWELED_ARROW.get(), new OptionalDispenseItemBehavior() {
