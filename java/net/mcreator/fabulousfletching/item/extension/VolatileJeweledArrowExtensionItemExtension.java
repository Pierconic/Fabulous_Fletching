...
public class VolatileJeweledArrowExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(FabulousfletchingModItems.VOLATILE_JEWELED_ARROW.get(), new OptionalDispenseItemBehavior() {
