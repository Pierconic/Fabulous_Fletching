...
public class SpectralJeweledArrowExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(FabulousfletchingModItems.SPECTRAL_JEWELED_ARROW.get(), new OptionalDispenseItemBehavior() {
