...
public class PrismaticForgedArrowExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(FabulousfletchingModItems.PRISMATIC_FORGED_ARROW.get(), new OptionalDispenseItemBehavior() {
