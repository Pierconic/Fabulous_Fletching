...
public class SpectralForgedArrowExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(FabulousfletchingModItems.SPECTRAL_FORGED_ARROW.get(), new OptionalDispenseItemBehavior() {
