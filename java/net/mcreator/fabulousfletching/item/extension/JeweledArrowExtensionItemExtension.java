...
public class JeweledArrowExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(FabulousfletchingModItems.JEWELED_ARROW.get(), new OptionalDispenseItemBehavior() {
