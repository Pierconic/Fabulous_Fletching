...
public class SeekingForgedArrowExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(FabulousfletchingModItems.SEEKING_FORGED_ARROW.get(), new OptionalDispenseItemBehavior() {
