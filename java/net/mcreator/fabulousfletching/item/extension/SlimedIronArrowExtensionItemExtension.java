...
public class SlimedIronArrowExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(FabulousfletchingModItems.SLIMED_IRON_ARROW.get(), new OptionalDispenseItemBehavior() {
