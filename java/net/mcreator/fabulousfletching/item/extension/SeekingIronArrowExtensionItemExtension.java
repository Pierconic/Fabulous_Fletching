...
public class SeekingIronArrowExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(FabulousfletchingModItems.SEEKING_IRON_ARROW.get(), new OptionalDispenseItemBehavior() {
