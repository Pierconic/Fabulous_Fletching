...
public class SeekingJeweledArrowExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(FabulousfletchingModItems.SEEKING_JEWELED_ARROW.get(), new OptionalDispenseItemBehavior() {
