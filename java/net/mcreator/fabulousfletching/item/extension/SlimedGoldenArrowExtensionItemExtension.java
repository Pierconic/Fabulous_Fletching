...
public class SlimedGoldenArrowExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(FabulousfletchingModItems.SLIMED_GOLDEN_ARROW.get(), new OptionalDispenseItemBehavior() {
