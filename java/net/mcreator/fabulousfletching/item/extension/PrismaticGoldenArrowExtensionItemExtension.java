...
public class PrismaticGoldenArrowExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(FabulousfletchingModItems.PRISMATIC_GOLDEN_ARROW.get(), new OptionalDispenseItemBehavior() {
