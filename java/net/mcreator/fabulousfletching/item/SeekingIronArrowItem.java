...
public class SeekingIronArrowItem extends ArrowItem {
	...
	public AbstractArrow createArrow(Level world, ItemStack stack, LivingEntity shooter, @Nullable ItemStack weapon){
		return new SeekingIronArrowProjectileEntity(FabulousfletchingModEntities.SEEKING_IRON_ARROW_PROJECTILE.get(), shooter, world, stack.copyWithCount(1));
	}

	@Override 
	public Projectile asProjectile(Level world, Position pos, ItemStack stack, Direction direction) {
		SeekingIronArrowProjectileEntity ironarrow = new SeekingIronArrowProjectileEntity(FabulousfletchingModEntities.SEEKING_IRON_ARROW_PROJECTILE.get(), pos.x(), pos.y(), pos.z(), world, stack.copyWithCount(1));
