...
public class VolatileJeweledArrowItem extends ArrowItem {
	public VolatileJeweledArrowItem() {
		super(new Item.Properties().stacksTo(64));
	}
	
	@Override
	public AbstractArrow createArrow(Level world, ItemStack stack, LivingEntity shooter, @Nullable ItemStack weapon){
		return new VolatileJeweledArrowProjectileEntity(FabulousfletchingModEntities.VOLATILE_JEWELED_ARROW_PROJECTILE.get(), shooter, world, stack.copyWithCount(1));
	}

	@Override 
	public Projectile asProjectile(Level world, Position pos, ItemStack stack, Direction direction) {
		VolatileJeweledArrowProjectileEntity jeweledarrow = new VolatileJeweledArrowProjectileEntity(FabulousfletchingModEntities.VOLATILE_JEWELED_ARROW_PROJECTILE.get(), pos.x(), pos.y(), pos.z(), world, stack.copyWithCount(1));
