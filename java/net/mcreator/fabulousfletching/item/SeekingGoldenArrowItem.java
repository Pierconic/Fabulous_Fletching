...
public class SeekingGoldenArrowItem extends ArrowItem {
	public SeekingGoldenArrowItem() {
		super(new Item.Properties().stacksTo(64));
	}
	
	@Override
	public AbstractArrow createArrow(Level world, ItemStack stack, LivingEntity shooter, @Nullable ItemStack weapon){
		return new SeekingGoldenArrowProjectileEntity(FabulousfletchingModEntities.SEEKING_GOLDEN_ARROW_PROJECTILE.get(), shooter, world, stack.copyWithCount(1));
	}

	@Override 
	public Projectile asProjectile(Level world, Position pos, ItemStack stack, Direction direction) {
		SeekingGoldenArrowProjectileEntity goldenarrow = new SeekingGoldenArrowProjectileEntity(FabulousfletchingModEntities.SEEKING_GOLDEN_ARROW_PROJECTILE.get(), pos.x(), pos.y(), pos.z(), world, stack.copyWithCount(1));
