...
public class PrismaticIronArrowItem extends ArrowItem {
	public PrismaticIronArrowItem() {
		super(new Item.Properties().stacksTo(64));
	}
	
	@Override
	public AbstractArrow createArrow(Level world, ItemStack stack, LivingEntity shooter, @Nullable ItemStack weapon){
		return new PrismaticIronArrowProjectileEntity(FabulousfletchingModEntities.PRISMATIC_IRON_ARROW_PROJECTILE.get(), shooter, world, stack.copyWithCount(1));
	}

	@Override 
	public Projectile asProjectile(Level world, Position pos, ItemStack stack, Direction direction) {
		PrismaticIronArrowProjectileEntity ironarrow = new PrismaticIronArrowProjectileEntity(FabulousfletchingModEntities.PRISMATIC_IRON_ARROW_PROJECTILE.get(), pos.x(), pos.y(), pos.z(), world, stack.copyWithCount(1));
