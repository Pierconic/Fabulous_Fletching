...
public class SpectralJeweledArrowItem extends ArrowItem {
	public SpectralJeweledArrowItem() {
		super(new Item.Properties().stacksTo(64));
	}
	
	@Override
	public AbstractArrow createArrow(Level world, ItemStack stack, LivingEntity shooter, @Nullable ItemStack weapon){
		return new SpectralJeweledArrowProjectileEntity(FabulousfletchingModEntities.SPECTRAL_JEWELED_ARROW_PROJECTILE.get(), shooter, world, stack.copyWithCount(1));
	}

	@Override 
	public Projectile asProjectile(Level world, Position pos, ItemStack stack, Direction direction) {
		SpectralJeweledArrowProjectileEntity jeweledarrow = new SpectralJeweledArrowProjectileEntity(FabulousfletchingModEntities.SPECTRAL_JEWELED_ARROW_PROJECTILE.get(), pos.x(), pos.y(), pos.z(), world, stack.copyWithCount(1));
