...
public class PrismaticGoldenArrowItem extends ArrowItem {
	public PrismaticGoldenArrowItem() {
		super(new Item.Properties().stacksTo(64));
	}
	
	@Override
	public AbstractArrow createArrow(Level world, ItemStack stack, LivingEntity shooter, @Nullable ItemStack weapon){
		return new PrismaticGoldenArrowProjectileEntity(FabulousfletchingModEntities.PRISMATIC_GOLDEN_ARROW_PROJECTILE.get(), shooter, world, stack.copyWithCount(1));
	}

	@Override 
	public Projectile asProjectile(Level world, Position pos, ItemStack stack, Direction direction) {
		PrismaticGoldenArrowProjectileEntity goldenarrow = new PrismaticGoldenArrowProjectileEntity(FabulousfletchingModEntities.PRISMATIC_GOLDEN_ARROW_PROJECTILE.get(), pos.x(), pos.y(), pos.z(), world, stack.copyWithCount(1));
