...
public class SpectralForgedArrowItem extends ArrowItem {
	public SpectralForgedArrowItem() {
	...
	public AbstractArrow createArrow(Level world, ItemStack stack, LivingEntity shooter, @Nullable ItemStack weapon){
		return new SpectralForgedArrowProjectileEntity(FabulousfletchingModEntities.SPECTRAL_FORGED_ARROW_PROJECTILE.get(), shooter, world, stack.copyWithCount(1));
	}

	@Override 
	public Projectile asProjectile(Level world, Position pos, ItemStack stack, Direction direction) {
		SpectralForgedArrowProjectileEntity forgedarrow = new SpectralForgedArrowProjectileEntity(FabulousfletchingModEntities.SPECTRAL_FORGED_ARROW_PROJECTILE.get(), pos.x(), pos.y(), pos.z(), world, stack.copyWithCount(1));
