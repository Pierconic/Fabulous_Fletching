...
public class FlintArrowItem extends ArrowItem {
	public FlintArrowItem() {
		super(new Item.Properties().stacksTo(64));
	}
	
	@Override
	public AbstractArrow createArrow(Level world, ItemStack stack, LivingEntity shooter, @Nullable ItemStack weapon){
		return new FlintArrowProjectileEntity(FabulousfletchingModEntities.FLINT_ARROW_PROJECTILE.get(), shooter, world, stack.copyWithCount(1));
	}

	@Override 
	public Projectile asProjectile(Level world, Position pos, ItemStack stack, Direction direction) {
		FlintArrowProjectileEntity flintarrow = new FlintArrowProjectileEntity(FabulousfletchingModEntities.FLINT_ARROW_PROJECTILE.get(), pos.x(), pos.y(), pos.z(), world, stack.copyWithCount(1));
		flintarrow.pickup = AbstractArrow.Pickup.ALLOWED;
		return flintarrow;
	}
}
	//@Override
