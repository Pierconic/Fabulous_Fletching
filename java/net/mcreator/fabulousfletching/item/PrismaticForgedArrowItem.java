...
public class PrismaticForgedArrowItem extends ArrowItem {
	public PrismaticForgedArrowItem() {
	...
	public AbstractArrow createArrow(Level world, ItemStack stack, LivingEntity shooter, @Nullable ItemStack weapon){
		return new PrismaticForgedArrowProjectileEntity(FabulousfletchingModEntities.PRISMATIC_FORGED_ARROW_PROJECTILE.get(), shooter, world, stack.copyWithCount(1));
	}

	@Override 
	public Projectile asProjectile(Level world, Position pos, ItemStack stack, Direction direction) {
		PrismaticForgedArrowProjectileEntity forgedarrow = new PrismaticForgedArrowProjectileEntity(FabulousfletchingModEntities.PRISMATIC_FORGED_ARROW_PROJECTILE.get(), pos.x(), pos.y(), pos.z(), world, stack.copyWithCount(1));
		forgedarrow.pickup = AbstractArrow.Pickup.ALLOWED;
		return forgedarrow;
	}
}
	//@Override
