...
public class GoldenArrowItem extends ArrowItem {
	...
	public AbstractArrow createArrow(Level world, ItemStack stack, LivingEntity shooter, @Nullable ItemStack weapon){
		return new GoldenArrowProjectileEntity(FabulousfletchingModEntities.GOLDEN_ARROW_PROJECTILE.get(), shooter, world, stack.copyWithCount(1));
	}

	@Override 
	public Projectile asProjectile(Level world, Position pos, ItemStack stack, Direction direction) {
		GoldenArrowProjectileEntity goldenarrow = new GoldenArrowProjectileEntity(FabulousfletchingModEntities.GOLDEN_ARROW_PROJECTILE.get(), pos.x(), pos.y(), pos.z(), world, stack.copyWithCount(1));
