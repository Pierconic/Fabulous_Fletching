...
public class SeekingCourseCorrectionProcedure {
	public static void execute(LevelAccessor world, Entity entity, Entity immediatesourceentity, double range) {
		...
		if (!world.getEntitiesOfClass(LivingEntity.class, AABB.ofSize(new Vec3((immediatesourceentity.getX()), (immediatesourceentity.getY()), (immediatesourceentity.getZ())), range, range, range), e -> true).isEmpty() && !(((Entity) world
				.getEntitiesOfClass(LivingEntity.class, AABB.ofSize(new Vec3((immediatesourceentity.getX()), (immediatesourceentity.getY()), (immediatesourceentity.getZ())), range, range, range), e -> true).stream().sorted(new Object() {
			...
			horizontaltheta = Math.atan(Math.abs(immediatesourceentity.getX() - ((Entity) world
					.getEntitiesOfClass(LivingEntity.class, AABB.ofSize(new Vec3((immediatesourceentity.getX()), (immediatesourceentity.getY()), (immediatesourceentity.getZ())), range, range, range), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
							return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
						}
			...
			verticaltheta = Math.atan(Math.abs(immediatesourceentity.getY() - ((Entity) world
					.getEntitiesOfClass(LivingEntity.class, AABB.ofSize(new Vec3((immediatesourceentity.getX()), (immediatesourceentity.getY()), (immediatesourceentity.getZ())), range, range, range), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
							return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
						}
			...
			if (((Entity) world.getEntitiesOfClass(LivingEntity.class, AABB.ofSize(new Vec3((immediatesourceentity.getX()), (immediatesourceentity.getY()), (immediatesourceentity.getZ())), range, range, range), e -> true).stream()
					.sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
							return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
						}
